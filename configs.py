...
class Config(object):
	BOT_TOKEN = os.environ.get("6328374317:AAHkCzq47FK252GeJ_Uf1HNxRut24GPKpoI")
	API_ID = int(os.environ.get("22404062", 12345))
	...
	LOG_CHANNEL = int(os.environ.get("1001980529724"))
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", None)
	DOWN_PATH = os.environ.get("DOWN_PATH", "./downloads")
	PRESET = os.environ.get("PRESET", "ultrafast")
	OWNER_ID = int(os.environ.get("1165215979", 1445283714))
	CAPTION = "By @AHToolsBot"
	BOT_USERNAME = os.environ.get("dpx_mux_bot", "VideoWatermark_Bot")
